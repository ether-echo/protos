...
const (
	...
	UserService_GetAllID_FullMethodName     = "/user.UserService/GetAllID"
)
...
type UserServiceClient interface {
	...
	GetAllID(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*IdList, error)
}
...
func (c *userServiceClient) GetAllID(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*IdList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdList)
	err := c.cc.Invoke(ctx, UserService_GetAllID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetAllID(context.Context, *Empty) (*IdList, error)
...
func (UnimplementedUserServiceServer) GetAllID(context.Context, *Empty) (*IdList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllID not implemented")
}
...
func _UserService_GetAllID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetAllID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetAllID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetAllID(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllID",
			Handler:    _UserService_GetAllID_Handler,
		},
	},
