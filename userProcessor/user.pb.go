...
const file_user_proto_rawDesc = "" +
	...
	"\vSaveMessage\x12\x14.user.MessageRequest\x1a\x15.user.MessageResponseB\x11Z\x0f/;userProcessorb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 2: user.UserService.StartMessage:output_type -> user.StartResponse
	3, // 3: user.UserService.SaveMessage:output_type -> user.MessageResponse
